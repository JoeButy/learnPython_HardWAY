...
# object 	-- Two meaning: the most basic type of thing, and any instance
				# of some thing.
...
# self		-- Inside the function in a class, self is a variable for the instance/object
				# being accessed.
...
# is-a		-- A phrase to say that something inherits from another, as in "salmon" is-a 
				# "Fish"
